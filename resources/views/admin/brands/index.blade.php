        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    {{-- <form class="" action="{{ route('admin.brands.search') }}" method="post">
                        @csrf
                    ...
                    <table class="table table-striped table-sm">
                        ...
                        <tbody>
                            @foreach ($brands as $item)
                                <tr>
                                    <td>{{ $item->id }}</td>
                                    <td> <a href="{{ route('admin.brands.show', $item->id) }}">
                                            {{ $item->name }}</a></td>
                                    {{-- <td>{{ $item->image }}</td> --}}
                                    ...
                                    <td>
                                        <a class="btn btn-primary"
                                            href="{{ route('admin.brands.edit', $item->id) }}">Update</a>
