                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i>0372 762 140</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> halchph10019@fpt.edu.vn</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="{{ route('root') }}"><img src="{{ asset('images/home/logo.png') }}"
                                    alt="" /></a>
                        </div>
